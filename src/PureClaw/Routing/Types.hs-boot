...
--
-- 'PureClaw.Agent.Env' references 'RoutingConfig' and 'ChannelEvent'
-- for the '_env_routingConfig' and '_env_tabOutQ' fields. The full
-- module 'PureClaw.Routing.Types' imports
